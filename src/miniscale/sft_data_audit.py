...
from .sft_data import SFTCorpusIndex, truncate_sft_example
...
def audit_sft_jsonl(
    ...
    *,
    ...
    return {
        ...
        "token_sample": {
            "examples": len(sample),
            "raw_tokens": _percentiles(raw_lengths),
            "supervised_tokens": _percentiles(supervised_lengths),
            "retained_supervised_tokens": _percentiles(retained_supervised_lengths),
