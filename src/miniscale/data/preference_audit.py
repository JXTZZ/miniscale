...
def audit_dpo_jsonl(
    ...
    *,
    ...
    return {
        ...
        "token_sample": {
            "pairs": sample_count,
            "context_tokens": integer_percentiles(context_lengths),
            "chosen_target_tokens": integer_percentiles(chosen_lengths),
            "rejected_target_tokens": integer_percentiles(rejected_lengths),
