...
class SFTTests(unittest.TestCase):
    def test_production_steps_are_explicit_and_cli_defaults_have_one_source(self) -> None:
        ...
        mappings = {
            ...
            "early_stopping_validation_min_delta": "early_stopping_validation_min_delta",
            "early_stopping_quality_min_delta": "early_stopping_quality_min_delta",
            "severe_loop_rate_threshold": "severe_loop_rate_threshold",
